...
<head>
    ...
    @php
        $seoData = \App\Helpers\SeoHelper::generateMetaTags('contact', app()->getLocale());
        $schemaMarkup = \App\Helpers\SeoHelper::generateSchemaMarkup('contact');
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6">
                        <div class="form-section">
                            ...
                            <form id="contactForm" method="POST" action="{{ route('contact.store', ['locale' => app()->getLocale()]) }}">
                                @csrf
