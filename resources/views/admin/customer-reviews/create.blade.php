                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('rating') is-invalid @enderror" 
                                    ...
                                    <option value="1" {{ old('rating') == '1' ? 'selected' : '' }}>⭐ (1) - ضعيف جداً</option>
                                    <option value="2" {{ old('rating') == '2' ? 'selected' : '' }}>⭐⭐ (2) - ضعيف</option>
                                    <option value="3" {{ old('rating') == '3' ? 'selected' : '' }}>⭐⭐⭐ (3) - مقبول</option>
                                    <option value="4" {{ old('rating') == '4' ? 'selected' : '' }}>⭐⭐⭐⭐ (4) - جيد</option>
