        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit SEO Setting</h3>
                </div>
                    ...
                    <form action="{{ route('admin.seo.update', $seoSetting->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="page_type" name="page_type" required>
                                        ...
                                        @foreach($pageTypes as $type)
                                            <option value="{{ $type }}" {{ $seoSetting->page_type === $type ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="locale" name="locale" required>
                                        ...
                                        @foreach($locales as $locale)
                                            <option value="{{ $locale }}" {{ $seoSetting->locale === $locale ? 'selected' : '' }}>
                                                {{ strtoupper($locale) }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" 
                                      rows="3" required maxlength="500">{{ old('description', $seoSetting->description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="og_description" name="og_description" 
                                      rows="3" maxlength="500">{{ old('og_description', $seoSetting->og_description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="og_image" name="og_image" 
                                   value="{{ old('og_image', $seoSetting->og_image) }}" maxlength="500">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="twitter_description" name="twitter_description" 
                                      rows="3" maxlength="500">{{ old('twitter_description', $seoSetting->twitter_description) }}</textarea>
                            <div class="form-text">Leave empty to use main description</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="twitter_image" name="twitter_image" 
                                   value="{{ old('twitter_image', $seoSetting->twitter_image) }}" maxlength="500">
                            <div class="form-text">Full URL to the image</div>
                            @error('twitter_image')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
