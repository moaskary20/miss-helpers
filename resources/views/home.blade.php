        ...
        <div class="blog-slider" id="blogSlider">
            <div class="blog-track">
                @foreach($posts as $post)
                    @php $img = $post->featured_image ? Storage::url($post->featured_image) : asset('/images/hero-bg.jpg'); @endphp
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="maid-card h-100">
                        <div class="maid-image-wrapper">
                            <img src="{{ $maid->photo ? Storage::url($maid->photo) : asset('/images/default-maid.jpg') }}" 
